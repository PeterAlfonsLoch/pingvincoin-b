 ...
 *  A CTxDestination is the internal data type encoded in a pingvincoin address
 */
...
/**
 * Generate a Pingvincoin scriptPubKey for the given CTxDestination. Returns a P2PKH
