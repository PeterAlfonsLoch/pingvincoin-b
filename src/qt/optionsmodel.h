...
/** Interface from Qt to configuration data structure for Pingvincoin client.
...
public:
    ...
    PingvincoinUnit getDisplayUnit() const { return m_display_pingvincoin_unit; }
...
private:
    ...
    QString language;
    PingvincoinUnit m_display_pingvincoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(PingvincoinUnit unit);
