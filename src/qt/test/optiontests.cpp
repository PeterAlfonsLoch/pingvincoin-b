...
{
    // Test regression https://github.com/pingvincoin/pingvincoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/pingvincoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/pingvincoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Pingvincoin/Pingvincoin-Qt.conf and all else left as default,
    // pingvincoin-qt should set both -listen and -listenonion to false and start successfully.
