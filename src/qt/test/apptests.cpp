...
//! Entry point for PingvincoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &PingvincoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for PingvincoinGUI tests.
void AppTests::guiTests(PingvincoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &PingvincoinGUI::consoleShown, this, &AppTests::consoleTests);
