      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->pingvincoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->pingvincoinAtStartup);
    ...
    ui->pingvincoinAtStartup->setToolTip(ui->pingvincoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->pingvincoinAtStartup->setText(ui->pingvincoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openPingvincoinConfButton->setToolTip(ui->openPingvincoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new PingvincoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->pingvincoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openPingvincoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openPingvincoinConf())
