...
/* PingvincoinGUI -- Size of icons in status bar */
...
#define QAPP_APP_NAME_TESTNET4 "Pingvincoin-Qt-testnet4"
#define QAPP_APP_NAME_SIGNET "Pingvincoin-Qt-signet"
#define QAPP_APP_NAME_REGTEST "Pingvincoin-Qt-regtest"
