...
/**
  Pingvincoin GUI main class. This class represents the main window of the Pingvincoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class PingvincoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit PingvincoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~PingvincoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a pingvincoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, PingvincoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Pingvincoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(PingvincoinUnit newUnits);
