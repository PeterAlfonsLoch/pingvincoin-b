...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, PingvincoinUnits::SeparatorStyle separators=PingvincoinUnits::SeparatorStyle::STANDARD) const;
