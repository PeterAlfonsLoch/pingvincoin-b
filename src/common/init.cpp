// Copyright (c) 2023 The Pingvincoin Core developers
...
std::optional<ConfigError> InitConfig(ArgsManager& args, SettingsAbortFn settings_abort_fn)
{
    try {
        ...
        // pingvincoin.conf file just ignores the other file.)
        ...
        if (!fs::exists(base_path)) {
            ...
            // in https://github.com/pingvincoin/pingvincoin/issues/16220 about ways to
        ...
        // Show an error or warning if there is a pingvincoin.conf file in the
