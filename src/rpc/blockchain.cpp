...
static RPCHelpMan scanblocks()
{
    return RPCHelpMan{"scanblocks",
        ...
        "This call may take several minutes. Make sure to use no RPC timeout (pingvincoin-cli -rpcclienttimeout=0)",
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
    ...
    const fs::path& temppath)
{
...

    {
        ...
        //
        // See discussion here:
        //   https://github.com/pingvincoin/pingvincoin/pull/15606#discussion_r274479369
        //
        LOCK(::cs_main);
    ...
    // See also https://github.com/pingvincoin/pingvincoin/issues/25675
...
static RPCHelpMan loadtxoutset()
{
    return RPCHelpMan{
        ...
        "The result is a usable pingvincoind instance that is current with the network tip in a "
        ...
        "document (<https://github.com/pingvincoin/pingvincoin/blob/master/doc/design/assumeutxo.md>).",
        {
            {"path",
                RPCArg::Type::STR,
                RPCArg::Optional::NO,
