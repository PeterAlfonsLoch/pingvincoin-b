// Copyright (c) 2012-2022 The Pingvincoin Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.pingvincoincore.org", "www.pingvincoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.pingvincoincore.org]", "www.pingvincoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.pingvincoincore.org:80", "www.pingvincoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.pingvincoincore.org]:80", "www.pingvincoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.pingvincoincore.org:65536", "www.pingvincoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.pingvincoincore.org:0", "www.pingvincoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.pingvincoincore.org:", "www.pingvincoincore.org:", 0, false));
}
