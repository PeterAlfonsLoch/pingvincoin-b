#!/usr/bin/env bash
# Copyright (c) 2019-2022 The Pingvincoin Core developers
...
(
    ...
    # Setup the directory where our Pingvincoin Core build for HOST will be
    # installed. This directory will also later serve as the input for our
    # binary tarballs.
    INSTALLPATH="${PWD}/installed/${DISTNAME}"
    mkdir -p "${INSTALLPATH}"
    # Install built Pingvincoin Core to $INSTALLPATH
    case "$HOST" in
        *darwin*)
    ...
    (
        ...
        # copy over the example pingvincoin.conf file. if contrib/devtools/gen-pingvincoin-conf.sh
        # has not been run before buildling, this file will be a stub
        cp "${DISTSRC}/share/examples/pingvincoin.conf" "${DISTNAME}/"
