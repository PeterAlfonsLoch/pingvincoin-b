...
(define* (make-pingvincoin-cross-toolchain target
                                       #:key
...
desirable for building Pingvincoin Core release binaries."
...
;; failure; see https://github.com/pingvincoin/pingvincoin/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-pingvincoin-cross-toolchain target)))
