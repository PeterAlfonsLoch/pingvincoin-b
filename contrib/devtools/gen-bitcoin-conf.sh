...
BITCOIND=${BITCOIND:-$BINDIR/pingvincoind}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/pingvincoin.conf}
...
then
  ...
  echo -e "To safely generate a pingvincoin.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example pingvincoin.conf file in share/examples/'
...
##
## pingvincoin.conf configuration file.
## Generated by contrib/devtools/gen-pingvincoin-conf.sh.
##
...
# parse the output from pingvincoind --help
