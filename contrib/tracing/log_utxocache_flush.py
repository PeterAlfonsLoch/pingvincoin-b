...
"""Example logging Pingvincoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/pingvincoind
...
def main(pingvincoind_path):
    ...
    # to the tracepoints
    pingvincoind_with_usdts.enable_probe(
        probe="flush", fn_name="trace_flush")
    b = BPF(text=program, usdt_contexts=[pingvincoind_with_usdts])
