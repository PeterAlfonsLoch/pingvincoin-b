...
complete --command pingvincoind --no-files

# Extract options
function __fish_pingvincoind_get_options
...
complete \
    --command pingvincoind \
    --arguments "(__fish_pingvincoind_get_options --nofiles)"
