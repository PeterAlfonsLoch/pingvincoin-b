...
# Extract options
function __fish_pingvincoin_tx_get_options
...
# Extract commands
function __fish_pingvincoin_tx_get_commands
...
# Add options
complete \
    --command pingvincoin-tx \
    --condition "not __fish_pingvincoin_seen_cmd (__fish_pingvincoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_pingvincoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command pingvincoin-tx \
    --arguments "(__fish_pingvincoin_tx_get_commands)" \
    --no-files
