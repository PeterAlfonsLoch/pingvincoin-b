...
complete --command pingvincoin-qt --no-files

# Extract options
function __fish_pingvincoinqt_get_options
...
complete \
    --command pingvincoin-qt \
    --arguments "(__fish_pingvincoinqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c pingvincoin-qt \
...
complete \
    --command pingvincoin-qt \
    --arguments "(__fish_pingvincoinqt_get_options --nofiles)"
