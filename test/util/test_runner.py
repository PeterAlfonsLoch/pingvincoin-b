...
# Copyright 2016-2017 The Pingvincoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test framework for pingvincoin utils.
...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "pingvincoin-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./pingvincoin-util":
        execprog = os.getenv("BITCOINUTIL", default=execprog)
    elif testObj["exec"] == "./pingvincoin-tx":
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, pingvincoin-tx
