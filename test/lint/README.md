...
```sh
DOCKER_BUILDKIT=1 docker build -t pingvincoin-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/pingvincoin -it pingvincoin-linter
```
...
maintained:
* for `src/secp256k1`: https://github.com/pingvincoin-core/secp256k1.git (branch master)
* for `src/leveldb`: https://github.com/pingvincoin-core/leveldb-subtree.git (branch pingvincoin-fork)
* for `src/crypto/ctaes`: https://github.com/pingvincoin-core/ctaes.git (branch master)
* for `src/crc32c`: https://github.com/pingvincoin-core/crc32c-subtree.git (branch pingvincoin-fork)
* for `src/minisketch`: https://github.com/sipa/minisketch.git (branch master)

To do so, add the upstream repository as remote:

```
git remote add --fetch secp256k1 https://github.com/pingvincoin-core/secp256k1.git
```
