#!/usr/bin/env python3
# Copyright (c) 2020-present The Pingvincoin Core developers
...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The pingvincoind node closes feeler connections as soon as a version
...
class P2PAddConnections(PingvincoinTestFramework):
    ...
    def run_test(self):
        ...
        # pingvincoind behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that pingvincoind sends its own version prior to processing
