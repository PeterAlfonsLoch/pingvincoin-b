#!/usr/bin/env python3
# Copyright (c) 2019-2021 The Pingvincoin Core developers
...
class TxDownloadTest(PingvincoinTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new pingvincoind instances, as setting mocktimes has long-term effects on when
