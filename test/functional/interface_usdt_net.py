...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/pingvincoin/pingvincoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(PingvincoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our pingvincoind node")
