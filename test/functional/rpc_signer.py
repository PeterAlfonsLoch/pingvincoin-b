...
Verify that a pingvincoind node can use an external signer command.
...
class RPCSignerTest(PingvincoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart pingvincoind with -signer=<cmd>',
