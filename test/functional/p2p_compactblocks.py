...
# TestP2PConn: A peer we use to send messages to pingvincoind, and store responses.
...
class CompactBlocksTest(PingvincoinTestFramework):
    ...
    # This test actually causes pingvincoind to (reasonably!) disconnect us, so do this last.
    ...
    # pingvincoind's choice of nonce.
    ...
    # Test that pingvincoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for pingvincoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # pingvincoind will not send blocktxn responses for blocks whose height is
