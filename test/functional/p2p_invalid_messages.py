#!/usr/bin/env python3
# Copyright (c) 2015-2021 The Pingvincoin Core developers
...
class InvalidMessagesTest(PingvincoinTestFramework):
    ...
    def test_addrv2(self, label, required_log_messages, raw_addrv2):
        ...
        # Make sure pingvincoind signals support for ADDRv2, otherwise this test
