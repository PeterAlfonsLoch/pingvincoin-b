...
class TestPingvincoinCli(PingvincoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `pingvincoin-cli getblockchaininfo`")
        ...
        # Prevent pingvincoin-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and pingvincoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and pingvincoin-cli getwalletinfo return expected wallet info")
            ...
            # Test pingvincoin-cli -generate with -rpcwallet in multiwallet mode.
...
if __name__ == '__main__':
    TestPingvincoinCli(__file__).main()
