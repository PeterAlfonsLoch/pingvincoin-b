...
By default, pingvincoind will dump mempool on shutdown and
...
class MempoolPersistTest(PingvincoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent pingvincoind from writing mempool.dat to disk. Verify that `savemempool` fails")
