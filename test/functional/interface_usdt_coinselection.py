...
"""  Tests the coin_selection:* tracepoint API interface.
     See https://github.com/pingvincoin/pingvincoin/blob/master/doc/tracing.md#context-coin_selection
"""
...
class CoinSelectionTracepointTest(PingvincoinTestFramework):
