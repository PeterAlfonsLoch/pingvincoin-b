#!/usr/bin/env python3
# Copyright (c) 2023-present The Pingvincoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test running pingvincoind with -reindex from a read-only blockstore
...
class BlockstoreReindexTest(PingvincoinTestFramework):
