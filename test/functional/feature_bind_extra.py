...
"""
Test starting pingvincoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(PingvincoinTestFramework):
    ...
    def run_test(self):
        for i, (args, expected_services) in enumerate(self.expected):
            ...
            # that pingvincoind has bound on "::1" (for RPC) and "::" (for P2P).
