...
"""  Tests the mempool:* tracepoint API interface.
     See https://github.com/pingvincoin/pingvincoin/blob/master/doc/tracing.md#context-mempool
"""
...
class MempoolTracepointTest(PingvincoinTestFramework):
    ...
    def rejected_test(self):
        ...
        # https://github.com/pingvincoin/pingvincoin/issues/27380
