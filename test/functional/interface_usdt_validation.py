...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/pingvincoin/pingvincoin/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(PingvincoinTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/pingvincoin/pingvincoin/blob/master/doc/tracing.md#tracepoint-validationblock_connected
