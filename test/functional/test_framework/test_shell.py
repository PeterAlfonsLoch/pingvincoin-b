...
class TestShell:
    """Wrapper Class for PingvincoinTestFramework.

    The TestShell class extends the PingvincoinTestFramework
    ...
    class __TestShell(PingvincoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by PingvincoinTestFramework child class.
            self.num_nodes = 1
