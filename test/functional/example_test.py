...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the PingvincoinTestFramework
    pass


class ExampleTest(PingvincoinTestFramework):
    # Each functional test is a subclass of the PingvincoinTestFramework class.
    ...
    def custom_method(self):
        ...
        PingvincoinTestFramework class so other tests can use it."""
