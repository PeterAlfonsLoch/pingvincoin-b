...
class RawTransactionsTest(PingvincoinTestFramework):
    ...
    def getrawtransaction_verbosity_tests(self):
        ...
        # Do this with a pruned chain, as a regression test for https://github.com/pingvincoin/pingvincoin/pull/29003
    ...
    def createrawtransaction_tests(self):
        ...
        assert_raises_rpc_error(-5, "Invalid Pingvincoin address", self.nodes[0].createrawtransaction, [], {'foo': 0})
    ...
    def decoderawtransaction_tests(self):
        ...
        assert_equal(decrawtx['vout'][0]['value'], Decimal('1.00000000'))
        # known ambiguous transaction in the chain (see https://github.com/pingvincoin/pingvincoin/issues/20579)
