Pingvincoin Core version 0.14.1 is now available from:

  <https://pingvincoin.org/bin/pingvincoin-core-0.14.1/>
...
here:
[reducing-pingvincoind-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` pingvincoin-tx input verification (awemany, jnewbery)
