Pingvincoin Core version 0.14.2 is now available from:

  <https://pingvincoin.org/bin/pingvincoin-core-0.14.2/>
...
(in Pingvincoin Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate pingvincoin-config.h as necessary (theuni)
