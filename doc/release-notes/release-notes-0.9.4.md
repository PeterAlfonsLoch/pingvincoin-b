Pingvincoin Core version 0.9.4 is now available from:

  https://pingvincoin.org/bin/0.9.4/
...
this update is incompatible with the Pingvincoin system and could lead to consensus
forks.

Pingvincoin Core released binaries from https://pingvincoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~pingvincoin/+archive/ubuntu/pingvincoin
- A third-party or self-compiled Pingvincoin Core

upgrade to Pingvincoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
