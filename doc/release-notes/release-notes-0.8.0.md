Pingvincoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/pingvincoin/files/Pingvincoin/pingvincoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Pingvincoin
...
New/changed settings (command-line or pingvincoin.conf file)
--------------------------------------------------------
