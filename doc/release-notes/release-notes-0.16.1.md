Pingvincoin Core version 0.16.1 is now available from:

  <https://pingvincoincore.org/bin/pingvincoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting pingvincoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure pingvincoind processes are cleaned up when tests end (sdaftuar)
