Pingvincoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/pingvincoin/files/Pingvincoin/pingvincoin-0.5.4/
...
http://gitorious.org/pingvincoin/pingvincoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Pingvincoin-Qt notifications under Growl 1.3.
Increase required age of Pingvincoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxPingvincoin properly when installing Pingvincoin-Qt over it. (Windows)
