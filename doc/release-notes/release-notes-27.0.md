Pingvincoin Core version 27.0 is now available from:

  <https://pingvincoincore.org/bin/pingvincoin-core-27.0/>
...
using the Linux Kernel 3.17+, macOS 11.0+, and Windows 7 and newer. Pingvincoin
...
libpingvincoinconsensus
-------------------

- libpingvincoinconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libpingvincoinkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Pingvincoin Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Pingvincoin Core would
