Download URL: https://sourceforge.net/projects/pingvincoin/files/Pingvincoin/pingvincoin-0.3.22/
...
* IRC is overflowing.  Client now bootstraps to channels #pingvincoin00 - #pingvincoin99
