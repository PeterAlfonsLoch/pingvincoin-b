Pingvincoin Core version 0.16.3 is now available from:

  <https://pingvincoincore.org/bin/pingvincoin-core-0.16.3/>
...
been discovered in Pingvincoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` pingvincoinconsensus: invalid flags error should be set to `pingvincoinconsensus_err` (afk11)
