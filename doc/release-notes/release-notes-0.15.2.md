Pingvincoin Core version *0.15.2* is now available from:

  <https://pingvincoincore.org/bin/pingvincoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in pingvincoin-tx (TheBlueMatt)
