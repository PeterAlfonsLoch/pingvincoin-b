Pingvincoin Core version 0.10.4 is now available from:

  <https://pingvincoin.org/bin/pingvincoin-core-0.10.4/>
...
- #6953 `43c2789` Split pingvincoin-tx into its own package
- #6953 `dfe0d4d` Include pingvincoin-tx binary on Debian/Ubuntu
