Pingvincoin Core version 0.13.2 is now available from:

  <https://pingvincoin.org/bin/pingvincoin-core-0.13.2/>
...
- #8908 `4a974b2` Update pingvincoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow pingvincoin-tx to create v2 transactions (btcdrak)
