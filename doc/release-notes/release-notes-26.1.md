...
Pingvincoin Core version 26.1 is now available from:

  <https://pingvincoincore.org/bin/pingvincoin-core-26.1/>
...
using the Linux kernel, macOS 11.0+, and Windows 7 and newer.  Pingvincoin
