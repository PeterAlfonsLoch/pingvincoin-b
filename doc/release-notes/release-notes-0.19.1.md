...
Pingvincoin Core version 0.19.1 is now available from:

  <https://pingvincoincore.org/bin/pingvincoin-core-0.19.1/>
...
From Pingvincoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Pingvincoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Pingvincoin Core does not yet change appearance when
...
- #17488 fix "pingvincoind already running" warnings on macOS (fanquake)
